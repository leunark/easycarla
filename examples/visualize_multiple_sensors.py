...
class SensorManager:
    ...
    def init_sensor(self, sensor_type: SensorType, transform, attached: carla.Actor, sensor_options: dict):
        ...
        elif sensor_type == SensorType.CAMERA_DEPTH_CAMERA:
        ...
        elif sensor_type == SensorType.CAMERA_INSTANCE_SEGMENTATION:
        ...
        elif sensor_type == SensorType.LIDAR_SEMANTIC_SEGMENTATION:
...
def run_simulation(args, client):
    ...
    try:
        ...
        SensorManager(world, display_manager, SensorType.CAMERA_RGB, carla.Transform(carla.Location(x=0, z=2.4), carla.Rotation(yaw=180)), 
                      vehicle, {}, display_pos=[1, 1])

        SensorManager(world, display_manager, SensorType.LIDAR, carla.Transform(carla.Location(x=0, z=2.4)), 
                      vehicle, {'channels' : '64', 'range' : '100',  'points_per_second': '250000', 'rotation_frequency': '20'}, display_pos=[1, 0])
        SensorManager(world, display_manager, SensorType.LIDAR_SEMANTIC_SEGMENTATION, carla.Transform(carla.Location(x=0, z=2.4)), 
